...
end_epoch = 0           # final value for epsilon after decay
learn_num = 1           # number of learning passes
ou_sigma = 0.2          # Ornstein-Uhlenbeck noise parameter, volatility
ou_theta = 0.13         # Ornstein-Uhlenbeck noise parameter, speed of mean reversion
learn_every = 1         # learning timestep interval
start_epoch = 5.0         # initial value for epsilon in noise decay process in Agent.act()
lr_actor = 1e-3         # learning rate of the actor
lr_critic = 1e-3      # learning rate of the critic
batch_size = 128        # minibatch size
epoch_decay = 250        # episode to end the noise decay process
...
class Agent():
    ...
    def __init__(self, state_size, action_size, num_agents, random_seed):
        ...
        self.eps = start_epoch
        self.eps_decay = 1/(epoch_decay*learn_num)  # set decay rate based on epsilon end target
        self.timestep = 0
    ...
    def learn(self, experiences, gamma, agent_number):
        ...
        self.eps = max(self.eps, end_epoch)
        self.noise.reset()
